      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-white to-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-20 pb-12 sm:pb-16">
          <div className="text-center">
            <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-medium mb-6 sm:mb-8">
              <Brain className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
              <span className="hidden sm:inline">AI-Powered Creative Intelligence</span>
              <span className="sm:hidden">AI Creative Intelligence</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight px-2">
              <span className="block">Transform Your Ads</span>
              <span className="block text-primary">with AI-Powered</span>
              <span className="block">Creative Intelligence</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-6 sm:mb-8 max-w-4xl mx-auto px-4 sm:px-0 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12 px-4 sm:px-0">
              <Button size="lg" className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg bg-primary hover:bg-primary/90">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div className="hidden lg:block absolute top-1/2 left-1/3 transform -translate-y-1/2 -translate-x-1/2">
              <ArrowRight className="w-5 h-5 xl:w-6 xl:h-6 text-gray-400" />
            </div>
            <div className="hidden lg:block absolute top-1/2 right-1/3 transform -translate-y-1/2 translate-x-1/2">
              <ArrowRight className="w-5 h-5 xl:w-6 xl:h-6 text-gray-400" />
            </div>

            {/* Connection arrows - Mobile/Tablet (Vertical) */}
            <div className="block md:hidden absolute left-1/2 top-[33.33%] transform -translate-x-1/2 -translate-y-1/2 rotate-90">
              <ArrowRight className="w-5 h-5 text-gray-400" />
            </div>
            <div className="block md:hidden absolute left-1/2 top-[66.66%] transform -translate-x-1/2 -translate-y-1/2 rotate-90">
              <ArrowRight className="w-5 h-5 text-gray-400" />
            </div>

            {/* Connection arrows - Tablet (Horizontal but smaller) */}
            <div className="hidden md:block lg:hidden absolute top-1/2 left-1/3 transform -translate-y-1/2 -translate-x-1/2">
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
            <div className="hidden md:block lg:hidden absolute top-1/2 right-1/3 transform -translate-y-1/2 translate-x-1/2">
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
          </div>
        </div>
